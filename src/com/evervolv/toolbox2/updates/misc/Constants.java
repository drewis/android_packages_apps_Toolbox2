package com.evervolv.toolbox2.updates.misc;
...
public class Constants {
    ...
    public static final String API_URL = "http://test.panda/api/v1/list/";
    public static final String FETCH_URL = "http://test.panda/get/";
